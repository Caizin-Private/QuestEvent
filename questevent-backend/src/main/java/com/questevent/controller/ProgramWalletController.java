...
public class ProgramWalletController {
    ...
    @PostMapping
    @Operation(
            summary = "Create program wallet",
            description = "Creates a new program wallet for a user and program"
    )
    ...
    @Operation(
            summary = "Get user program wallets",
            description = "Retrieves all program wallets for a specific user"
    )
    ...
    public ResponseEntity<List<ProgramWalletBalanceDTO>> getUserProgramWalletBalances(
        ...
        return ResponseEntity.ok(
                programWalletService.getUserProgramWalletBalances(userId)
        );
    }
